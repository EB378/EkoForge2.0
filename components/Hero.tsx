...
const Hero = () => {
  ...
  return (
    <div className="relative w-full min-h-[45vh] overflow-hidden flex flex-col md:flex-row">
      {/* Background Image */}
      <motion.div
        initial="hidden"
        animate="visible"
      ...
      <div className="relative flex flex-col md:flex-row justify-between items-center w-full h-full px-6 sm:px-12">
        ...
        <div className="z-10 max-w-[90%] md:max-w-[60%] text-left md:text-left mt-10 md:mt-0">
          ...
          >
            {t("With Effective Digital Marketing Stratgies and Copy")}<br/>
            {t("With Effective Digital Marketing Stratgies and Copy2")}
          </motion.p>
        </div>
        ...
        <div className=" w-full md:w-[35%] h-auto md:h-[45vh]">
          {/* For Mobile: Thin Box */}
          <div className="flex md:hidden w-full bg-gradient-to-r from-purple-700 to-purple-500 rounded-lg px-4 py-3 items-center justify-between my-3 mt-6">
